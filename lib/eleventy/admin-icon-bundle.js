...
const ICONS = ["bar-chart-2", "bold", "chevron-down", "chevron-left", "chevron-up", "code", "external-link", "eye", "eye-off", "file", "file-text", "highlighter", "image", "italic", "link", "route", "pencil-line", "plus", "redo-2", "refresh-cw", "save", "send", "sliders-horizontal", "sparkles", "strikethrough", "superscript", "trash-2", "undo-2"];

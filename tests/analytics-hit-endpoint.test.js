...
//
// Der Schalter "Statistik an/aus" muss für beide Endpunkte gelten. Läge die
// Prüfung nur im alten GoatCounter-Proxy, bliebe die eigene Auswertung offen,
// und das Abschalten hielte nur im Browser.
test("beide Statistik-Endpunkte lesen denselben Schalter", async () => {
  ...
  for (const datei of ["functions/api/admin/stats.js", "functions/api/admin/analytics.js"]) {
